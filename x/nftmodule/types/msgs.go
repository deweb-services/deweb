...
func NewMsgEditNFT(tokenID, tokenData, sender string) *MsgEditNFT {
	return &MsgEditNFT{
		Id:     tokenID,
		Data:   tokenData,
		Sender: sender,
...
func NewMsgMintNFT(tokenID, tokenData, sender, recipient string) *MsgMintNFT {
	return &MsgMintNFT{
		Id:        tokenID,
		Data:      tokenData,
		Sender:    sender,
...
func NewMsgBurnNFT(sender, tokenID string) *MsgBurnNFT {
	return &MsgBurnNFT{
		Sender: sender,
		Id:     tokenID,
	}
