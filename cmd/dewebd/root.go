...
func NewRootCmd(
	...
	rootCmd := &cobra.Command{
		Use:   appName + "d",
		Short: "Decentralized Web Services Blockchain",
...
func initRootCmd(
	...
	for _, userCmd := range options.addSubCmds {
...
func queryCommand(moduleBasics module.BasicManager) *cobra.Command {
	...
	moduleBasics.AddQueryCommands(qcmd)
	qcmd.PersistentFlags().String(flags.FlagChainID, "", "The network chain ID")
...
func txCommand(moduleBasics module.BasicManager) *cobra.Command {
	...
	moduleBasics.AddTxCommands(txCmd)
